        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Commercial = table.Column<string>(maxLength: 100, nullable: false),
                    NumberVat = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VatRate = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VatTable", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentPhoto = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vat_Rate = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quotations_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cost = table.Column<double>(nullable: false),
                    SellPrice = table.Column<double>(nullable: false),
                    Total_Vat = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "QuotationsProducts",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QuotationsId = table.Column<int>(nullable: false),
                    ProductId = table.Column<int>(nullable: false),
                    Cost = table.Column<double>(nullable: false),
                    SellPrice = table.Column<double>(nullable: false),
                    Total_Vat = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuotationsProducts", x => x.ID);
                    table.ForeignKey(
                        name: "FK_QuotationsProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuotationsProducts_Quotations_QuotationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuotationsProducts_ProductId",
                table: "QuotationsProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_QuotationsProducts_QuotationsId",
                table: "QuotationsProducts",
                column: "QuotationsId");
