...
function addRow() {
    ...
    var myAspAttribute =document.createAttribute('name');
    myAspAttribute.value = "ProductIds"; 
    ...
    var myAspAttribute =document.createAttribute('name');
    myAspAttribute.value = "SellPrice"; 
