...
namespace Matjary.Controllers
{
    ...
    public class PurchasesInvoiceController : Controller
    {
        private readonly ApplicationDbContext _context;

        public PurchasesInvoiceController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: PurchasesInvoice
        public async Task<IActionResult> Index(int? page)
        {
            var applicationDbContext = _context.Invoices
                .Where(x => x.Invoice_Type == "مشتريات")
                .Include(i => i.Person);

            return View(applicationDbContext.ToPagedList(page ?? 1,10));
        }

        // GET: PurchasesInvoice/Details/5
        ...
        // POST: PurchasesInvoice/Delete/5
